...
Engine 1.3.0 includes the fix for Codex AgentMessage content blocks with type Text and provider-neutral transcript adapters. It also keeps summary and source-backed memory extraction in separate model roles. The regression fixture preserves the observed event shape with synthetic message text.
